...
function AboutUs () {
  ...
  return (
    <>
      <section className='py-10 bg-white dark:bg-gray-900 sm:py-16 lg:py-20'>
      ...
      <section className='bg-white dark:bg-gray-900 flex justify-center w-3/4 mx-auto'>
        <div className='container px-6 mx-auto'>
          <div className='lg:flex lg:-mx-12'>
            <div className='lg:mx-12'>
              ...
              <div className='mt-4 space-y-4 lg:mt-8 dark:text-gray-300'>
                <a
                  href='#website'
